...
INSERT INTO `users` (`User_id`, `Role_id`, `User_code`, `User_name`, `Email`, `Password`, `Full_name`, `Address`, `Phone_number`, `CCCD`, `Gender`, `Create_date`, `DOB`, `Pin`, `Update_date`) VALUES
